...
Один xlsx с двумя листами (оба пивот-таблицы персонаж × серия):

1. **Dialogue Summary** — по колонке **Dialog Word Count** (оригинал)
2. **Transcription Summary** — по колонке **Transcription Word Count** (перевод)

Структура обоих листов идентична, различаются только метрикой.
